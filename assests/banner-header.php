                    ...
                    <div class="extra-cell">
                        <div class="wt-topbar-right clearfix top-bar">
                            ...
                            <ul class="list-unstyled list-inline e-p-bx pull-right">
                                <li><i class="fa fa-envelope"></i><a href="mailto:reachus@t4studio.in" target="_blank" class="text-dark">reachus@t4studio.in</a></li>
                                <li><i class="fa fa-phone"></i><a href="tel:91850730714" target="_blank" class="text-dark">(+91) 85907 30714</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
