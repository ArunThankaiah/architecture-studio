<?php include_once('./assests/banner-header.php') ?>
<div class="page-wraper">
    <!-- CONTENT START -->
    <div class="page-content">
        <?php include_once('./assests/slide.php') ?>
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-lg-5 col-md-12 m-b30 text-uppercase text-black">
                            ...
                            <p>Founded three years ago, T4 Architecture Studio is dedicated to delivering personalized architectural solutions that stand apart from standardization. Our approach centers on listening closely to our clients' needs and aspirations, translating their ideas into designs that are uniquely suited to both the user and the site. At T4, we believe that every project is a collaboration, and our goal is to create spaces that reflect individuality and function seamlessly within their environment</p>
                            ...
                            <a href="about.php" class="btn-half site-button button-lg m-b15"><span>Read
                                    More</span><em></em></a>
                        </div>
        ...
        <?php include_once('./assests/ourservices.php') ?>
        <!-- OUR SERVICES SECTION END -->
